...
(function (window, document, undefined) {
  'use strict';
  angular.module('spica.pullToRefresh', ['pascalprecht.translate']).constant('pullToRefreshConfig', {
    treshold: 60,
    debounce: 400,
    text: {
      pull: 'PULL',
    ...
    '$translate',
    'pullToRefreshConfig',
    function ($compile, $timeout, $q, $translate, pullToRefreshConfig) {
      return {
        scope: true,
        restrict: 'A',
        transclude: true,
  ...
  angular.module('spica.pullToRefresh').run([
    '$templateCache',
